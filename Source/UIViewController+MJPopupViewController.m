...
//    [overlayView addSubview:self.mj_popupBackgroundView];
    ...
    switch (animationType) {
        ...
        case MJPopupViewAnimationSlideRightRight:
            ...
            break;
        case MJPopupViewAnimationCustomFade:
            dismissButton.tag = MJPopupViewAnimationFade;
            [self customFadeViewIn:popupView sourceView:sourceView];
            break;
        default:
            dismissButton.tag = MJPopupViewAnimationFade;
...
- (void)customFadeViewIn:(UIView *)popupView sourceView:(UIView *)sourceView
{
    CGRect popupEndRect = popupView.frame;
